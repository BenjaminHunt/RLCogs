...
# other functions
    ...
    async def prompt_with_buttons(self, ctx, bc_status_msg, search_embed, prompt_embed, success_embed, reject_embed, auth_token, member, match, with_retry=True):
        ...
        ## HERE #############################################################################################
        ok_button = Button(style=ButtonStyle.green, emoji=discord.PartialEmoji(":white_check_mark:"), label=":white_check_mark: Create Group", custom_id="create")
        retry_button = Button(style=ButtonStyle.blurple, emoji=discord.PartialEmoji(":grey_exclamation:"), label=":grey_exclamation: Search Again", custom_id="retry")
        cancel_button = Button(style=ButtonStyle.red, emoji=discord.PartialEmoji(":x:"), label=":x: Cancel", custom_id="cancel")
